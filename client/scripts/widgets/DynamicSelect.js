...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.updateState = function(clicked)
{
...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.getState = function()
{
	return this.state;
}

edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.setState = function(state)
{
	var self = this;
...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.get = function()
{
	return this.div;
}

edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.reset = function()
{
...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.prototype.update = function(data)
{
	this.currData = data;
...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.autocompleteSource = function(term, callback)
{
    var t = term;
...
edu.rpi.tw.sesf.s2s.widgets.DynamicSelect.autocompleteSelect = function(event, ui)
{
    var item = ui.item;
