...
/* Modified on Nov. 3, 2011 by Eric Rozell <rozele@rpi.edu>. Added method for dynamically loading CSS */
...
(function (a) {
    ...
    c = function (a, d, e) {
        ...
        for (var g in b) {
            ...
            (function (e) {
                a[e] = function () {
                    ...
                    if (e === "onError") {
                        if (d) {
                            b.onError.apply(a, [g, g.length]);
                            return a
                        }
                        var h = {};
                        b.onError.apply(h, [g, g.length]);
                        return c(h, null, "onError")
                    }
                    g.unshift(e);
                    if (!d)return c({}, [g], e);
                    a.then = a[e], d.push(g);
        ...
        e && (a.then = a[e]), a.call = function (b, c) {
...
addMethod('loadCss', function (args, argc) {
    for (var queue = [], i = 0; i < argc; i++) {
	(function (i) {
	    queue.push(asyncLoadCss(args[i]));
	}(i));
    }
    this.call('run',queue);
});
